...
const reviews = [
  {
    ...
    rating: 5,
    text: "Ilyce made our Rwanda safari absolutely magical! Her knowledge of wildlife and passion for conservation made every moment special. The gorilla trekking was a once-in-a-lifetime experience that exceeded all expectations.",
  ...
  },
  {
    ...
    location: "Germany",
    rating: 5,
    text: "Professional, knowledgeable, and incredibly friendly. Ilyce showed us parts of Akagera we never would have found on our own. The photography opportunities were endless and she knew exactly where to find the best wildlife.",
  ...
  },
  {
    ...
    rating: 5,
    text: "From start to finish, everything was perfectly organized. Ilyce's expertise and genuine love for Rwanda's wildlife made this the best safari experience we've ever had. Highly recommend to anyone visiting Rwanda!",
  ...
  },
  {
    ...
    location: "France",
    rating: 5,
    text: "The Nyungwe Forest adventure was incredible. Ilyce's knowledge of the forest ecosystem and her ability to spot wildlife was impressive. The canopy walk was breathtaking and the chimpanzee tracking unforgettable.",
    tour: "Nyungwe Forest Adventure",
    date: "August 2023"
  },
  {
    id: 5,
    ...
    location: "Canada",
    rating: 4,
    text: "Great city tour of Kigali! Ilyce provided wonderful insights into Rwanda's history and culture. The genocide memorial visit was deeply moving and educational. Perfect introduction to Rwanda.",
  ...
  },
  {
    ...
    location: "Spain",
    rating: 5,
    text: "Exceptional service and an unforgettable experience. Ilyce went above and beyond to ensure we saw everything we wanted. Her passion for wildlife conservation is inspiring and infectious.",
    tour: "Akagera National Park Safari",
    date: "June 2023"
  }
]
